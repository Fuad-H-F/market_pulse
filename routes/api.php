...
Route::group([
    ...
    Route::post('get_locations/{user_id}/{start_date}/{end_date}', [MapController::class, 'getLocations']);
    Route::post('get_multi_locations', [MapController::class, 'getMultiLocations']);
    Route::post('generate_report/{user_id}/{start_date}/{end_date}', [MapController::class, 'generateReport']);
    Route::post('generate_xlsx_report/{user_id}/{start_date}/{end_date}', [MapController::class, 'generateXlsxReport']);
    ...
    Route::post('donwload_all_report_as_one_pdf', [
        ReportDownloadController::class, 'donwloadAllReportAsOnePDF'
    ]);

    Route::post('donwload_all_report_as_one_xlsx', [
        ReportDownloadController::class, 'donwloadAllReportAsOneXlsx'
    ]);
});
